    ...
    void Update()
    {
        ...
        switch (castType)
        {
            ...
            case PhysicsType.CapsuleSingle:
                Physics.CapsuleCast(startPoint, capsuleSize, capsuleDirection, angle, transform.up, distance, preview, drawDuration, hitColor, noHitColor); ;
                break;
            case PhysicsType.CapsuleAll:
                Physics.CapsuleCastAll(startPoint, capsuleSize, capsuleDirection, angle, transform.up, distance, preview, drawDuration, hitColor, noHitColor);
                break;
            case PhysicsType.CapsuleNonAlloc:
                Physics.CapsuleCastNonAlloc(startPoint, capsuleSize, capsuleDirection, angle, transform.up, results, distance, preview, drawDuration, hitColor, noHitColor);
                break;
